...
const Navbar: React.CFC = ({ children }) => {
  ...
  const className = cx('border-b border-tech-cyan/15 -mx-2 ds:px-6 mb:px-3 flex mb:flex-col ds:items-center justify-between ds:sticky top-0 z-20 bg-bg-l1', {
  ...
  return (
    <FilterByTimeProvider>
      <div className={className}>
        <div className="flex items-center">
          <Icon className="size-6 mr-3 text-tech-cyan" name={icon} />
